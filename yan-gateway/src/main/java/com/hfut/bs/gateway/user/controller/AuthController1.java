...
import com.hfut.bs.gateway.utils.EncryptUtil;
...
public class AuthController1 {
    ...
    @ResponseBody
    public String doRegister(UserInfoModel authUser, String identiryCode, HttpServletRequest request) {
        //todo 验证码判断 暂时放开验证码拦截
...
//        }
    ...
    @ResponseBody
    public String ajaxLogin(UserInfoModel user, String identiryCode, Integer rememberMe, HttpServletRequest request){
        //验证码判断
        if(identiryCode!=null && !identiryCode.equalsIgnoreCase(SessionContext.getIdentifyCode(request))){
    ...
    public ModelAndView doLogin(UserInfoModel user, String identiryCode, HttpServletRequest request){
